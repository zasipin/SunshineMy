package app.learn.sunshineex.zasypinnv.sunshinemy.sync;

/**
 * Created by Николай on 28.04.2016.
 */
    ...
    private void getData(String location)
    {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APP_ID, "61c0547f277bf21ab39a9567aa4bbdd4")
                    .build();
...
//            String[] resultStrs = convertContentValuesToUXFormat(cVVector);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationSetting != null) {
            ...
            selectionArgs.add(locationSetting);
        }
